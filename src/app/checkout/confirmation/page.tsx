        ...
        <div className="w-full flex flex-col gap-y-6">
          ...
          <div className="bg-white shadow-xl p-6 md:p-8 rounded-lg">
            <div className="text-center">
              ...
              <Link
                href="/"
                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-[#2ECC71] hover:bg-[#A3BE8C] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2ECC71] transition-colors duration-300"
              >
